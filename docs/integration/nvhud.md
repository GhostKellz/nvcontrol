...
nvctl metrics export --format nvhud --socket ~/.local/state/nvcontrol/nvhud.sock
```
...
[backend]
type = "nvcontrol"
socket = "~/.local/state/nvcontrol/nvhud.sock"
refresh_rate_ms = 100
...
- [Backend Architecture](../config/backend-architecture.md) - nvcontrol backend design
